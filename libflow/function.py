...
def _ts_max(x1, d: int):
    ...
    return x1.rolling(int(d), min_periods=int(d / 2)).max()
...
function_map = {
    ...
    "min": min2,
    "mean": mean2,
    "clear_by_cond": clear_by_cond3,
    "if_then_else": if_then_else3,
    ...
    "ts_midpoint": ts_midpoint2,
    "ts_skew": ts_skew2,
    "ts_kurt": ts_kurt2,
    "ts_inverse cv": ts_inverse_cv2,
    "ts_cov": ts_cov3,
    "ts_corr": ts_corr3,
    "ts_autocorr": ts_autocorr3,
    "ts_maxmin": ts_maxmin2,
    "ts_zscore": ts_zscore2,
    "ts_regression beta": ts_regression_beta3,
    "ts_linear slope": ts_linear_slope2,
    "ts_linear intercept": ts_linear_intercept2,
    "ts_argmax": ts_argmax2,
    "ts_argmin": ts_argmin2,
    "ts_argmaxmin": ts_argmaxmin2,
    "ts_rank": ts_rank2,
    "ts_ema": ts_ema2,
    "ts_dema": ts_dema2,
    "ts_kama": ts_kama4,
    "ts_AROONOSC": ts_AROONOSC3,
    "ts_WR": ts_WR4,
    "ts_CCI": ts_CCI4,
    "ts_ATR": ts_ATR4,
    "ts_NATR": ts_NATR4,
